...
.brand-icon { width: 56px; height: 56px; margin: 0 auto 12px; }
...
.login-input { border-radius: 10px !important; height: 46px; }
...
.login-btn:hover { transform: translateY(-1px); box-shadow: 0 6px 20px rgba(79, 70, 229, 0.45) !important; }
